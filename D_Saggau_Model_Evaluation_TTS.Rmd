...
This paper will introduce a number of model evaluation metrics, focusing on popular extensions of the mean squared error and the area under the curve, adjusted for survival studies namely the brier score and the c-index, two methods that have gained prominence within the realms of scholarship and among clinicians.
...
Inevitably, this paper suggests that the integrated brier score is the more holistic model evaluation metric.
