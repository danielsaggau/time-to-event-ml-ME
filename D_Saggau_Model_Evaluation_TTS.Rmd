...
Haegerty et al. (2000) use the following mathematical notation:
...
This measure is less frequently used and mostly not the focus of clinicial studies.(Kamarudin et al., 2017).
...
As the second and third modifcation are rarely used, scholarship usually only focuses on the C/D variation.(Kamarudin et al., 2017).
...
### Wu, Y. C., & Lee, W. C. (2014)
* Lorenz Curve 
* Gini: Mean separation for the current model divided by the mean separation for an error free model 
