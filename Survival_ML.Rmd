...
* Traditional to evaluate statistical prediction we can quantify  eplained variation via R squared or brier score 
* Calibration can be quantified via Hosmer Lemeshow goodness of fit test
* Discrimination can be quantified via measure of sensitivty and specificity  via concordance statistics 
* New measures include reclassification tables, relcassification improvement and integrated discrimination improvement 
* The concept of risk reclassfication has caused substantial discussion in methdology and clinical literature 
