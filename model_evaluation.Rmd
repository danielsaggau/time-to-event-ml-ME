...
For the brier score, we are using a probability estimates $\pi(x^{i})$.
...
Typically, one makes the assumption that the censored data is missing data at random, or rephased our survival times are independent.
