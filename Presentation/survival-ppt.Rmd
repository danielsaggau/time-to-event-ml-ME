...
**Discrimination**:
Are we able to correctly discriminate between e.g. sick and healthy patients ?

**Calibration**:
How concise is our prediction accuracy ?

**Clinical Usefulness**: 
Will our model create more benefits than harm? 
...
crps(perror,times=seq(0,1,.25),start=0)
```
