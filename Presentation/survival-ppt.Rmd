...
$$\mathrm{AUC = Prob(Risk_t(i)> Risk_t(j)| i\: has\: event\: before\: t\: and \: j \: has\: event\: after \: t})$$
$$\mathrm{C = Prob(Risk_t(i)> Risk_t(j)| i\: has\: event\: before\: t)}$$
...
$C = \frac{\Delta_j \times \sum_{i,j}1_{Ti>Tj} \times 1_{\eta_i>\eta_j}} {\Delta_j \times \sum_{i,j}1_{Ti>Tj}}$
